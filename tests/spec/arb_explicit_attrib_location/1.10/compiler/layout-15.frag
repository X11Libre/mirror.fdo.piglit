...
// [end config]
//
// Even though the specified locations doesn't overlap, they could
// raise a *link* error.  The changes to section 3.9.2 say:
//
...
//
// Note that the third bullet point doesn't apply to this test, as the indices
// are different, making this test slightly different to layout-13. This test
// because this case was not handled correcty.
//
